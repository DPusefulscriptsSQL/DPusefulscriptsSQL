--EXEC spPS_GetProducts  NULL,NULL,53,NULL,NULL,N'lot1''));WAITFOR DELAY ''00:01''--',NULL
   
drop procedure sp_checkforReservedKeywords
go
 create procedure sp_checkforReservedKeywords
